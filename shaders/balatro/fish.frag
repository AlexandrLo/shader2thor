#define colour_1 vec4(62.0/255.0, 133.0/255.0, 189.0/255.0, 1.0)
...
// so the whole frame repeats exactly every ANIM_PERIOD seconds. fish.frag has
// an actual vortex rotation (spin_amount != 0, unlike the other balatro
// shaders), whose natural speed (~0.05 rad/s) needs a much longer period to
// fit well, hence ANIM_PERIOD=120 here instead of the 26 used elsewhere.
